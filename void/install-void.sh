...
# river (Wayland)
#sudo xbps-install -Suvy river Waybar xorg-server-xwayland xdg-desktop-portal-hyprland xdg-desktop-portal-gtk wl-clipboard wtype wlr-randr grim slurp tofi foot swayidle wlopm
