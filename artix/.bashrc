...
alias yt-dlp='cd $HOME/stuffs/dls/ && yt-dlp -S res:1080 -S vcodec:h264 --restrict-filenames -o "%(title)s.%(ext)s" --sponsorblock-remove all --audio-format mp3 '
...
alias update-rules='cd /etc/ananicy.d/ && sudo git pull'
